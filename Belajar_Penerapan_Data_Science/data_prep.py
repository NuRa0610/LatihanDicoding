...
# Load encoders
encoder_Application_mode = joblib.load(os.path.join(MODEL_DIR, 'encoder_Application_mode.joblib'))
encoder_Course = joblib.load(os.path.join(MODEL_DIR, 'encoder_Course.joblib'))
encoder_Daytime_evening_attendance = joblib.load(os.path.join(MODEL_DIR, 'encoder_Daytime_evening_attendance.joblib'))
encoder_Debtor = joblib.load(os.path.join(MODEL_DIR, 'encoder_Debtor.joblib'))
encoder_Displaced = joblib.load(os.path.join(MODEL_DIR, 'encoder_Displaced.joblib'))
encoder_Educational_special_needs = joblib.load(os.path.join(MODEL_DIR, 'encoder_Educational_special_needs.joblib'))
encoder_Fathers_occupation = joblib.load(os.path.join(MODEL_DIR, 'encoder_Fathers_occupation.joblib'))
encoder_Fathers_qualification = joblib.load(os.path.join(MODEL_DIR, 'encoder_Fathers_qualification.joblib'))
encoder_Gender = joblib.load(os.path.join(MODEL_DIR, 'encoder_Gender.joblib'))
encoder_International = joblib.load(os.path.join(MODEL_DIR, 'encoder_International.joblib'))
encoder_Marital_status = joblib.load(os.path.join(MODEL_DIR, 'encoder_Marital_status.joblib'))
encoder_Mothers_occupation = joblib.load(os.path.join(MODEL_DIR, 'encoder_Mothers_occupation.joblib'))
encoder_Mothers_qualification = joblib.load(os.path.join(MODEL_DIR, 'encoder_Mothers_qualification.joblib'))
encoder_Nacionality = joblib.load(os.path.join(MODEL_DIR, 'encoder_Nacionality.joblib'))
encoder_Previous_qualification = joblib.load(os.path.join(MODEL_DIR, 'encoder_Previous_qualification.joblib'))
encoder_Scholarship_holder = joblib.load(os.path.join(MODEL_DIR, 'encoder_Scholarship_holder.joblib'))
encoder_target = joblib.load(os.path.join(MODEL_DIR, 'encoder_target.joblib'))
encoder_Tuition_fees_up_to_date = joblib.load(os.path.join(MODEL_DIR, 'encoder_Tuition_fees_up_to_date.joblib'))

# Load scalers
scaler_Admission_grade = joblib.load(os.path.join(MODEL_DIR, 'scaler_Admission_grade.joblib'))
scaler_Curricular_units_1st_sem_approved = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_approved.joblib'))
scaler_Curricular_units_1st_sem_enrolled = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_enrolled.joblib'))
scaler_Curricular_units_1st_sem_credited = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_credited.joblib'))
scaler_Curricular_units_1st_sem_evaluations = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_evaluations.joblib'))
scaler_Curricular_units_1st_sem_grade = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_grade.joblib'))
scaler_Curricular_units_1st_sem_without_evaluations = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_1st_sem_without_evaluations.joblib'))
scaler_Curricular_units_2nd_sem_approved = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_approved.joblib'))
scaler_Curricular_units_2nd_sem_enrolled = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_enrolled.joblib'))
scaler_Curricular_units_2nd_sem_credited = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_credited.joblib'))
scaler_Curricular_units_2nd_sem_evaluations = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_evaluations.joblib'))
scaler_Curricular_units_2nd_sem_grade = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_grade.joblib'))
scaler_Curricular_units_2nd_sem_without_evaluations = joblib.load(os.path.join(MODEL_DIR, 'scaler_Curricular_units_2nd_sem_without_evaluations.joblib'))
scaler_GDP = joblib.load(os.path.join(MODEL_DIR, 'scaler_GDP.joblib'))
scaler_Inflation_rate = joblib.load(os.path.join(MODEL_DIR, 'scaler_Inflation_rate.joblib'))
scaler_Previous_qualification_grade = joblib.load(os.path.join(MODEL_DIR, 'scaler_Previous_qualification_grade.joblib'))
scaler_Unemployment_rate = joblib.load(os.path.join(MODEL_DIR, 'scaler_Unemployment_rate.joblib'))
